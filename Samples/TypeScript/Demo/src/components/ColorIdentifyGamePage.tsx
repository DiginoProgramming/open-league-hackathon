...
interface ColorIdentifyGamePageProps {}

const ColorIdentifyGamePage: React.FC<ColorIdentifyGamePageProps> = () => {
  ...
  return (
    <div>
      <iframe
        id="gameIframe"
        src="/colors/index.html"
        style={{ width: "100%", height: "100vh", border: "none" }}
        title="Color Identify Game Page"
      />
    </div>
  );
};

export default ColorIdentifyGamePage;
