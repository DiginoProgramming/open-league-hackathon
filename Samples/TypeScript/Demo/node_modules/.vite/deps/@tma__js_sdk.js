...
var le = class extends K {
  constructor(s, n, r) {
    ...
    c(this, "off", (s2, n2) => s2 === "click" ? $("back_button_pressed", n2) : this.state.off(s2, n2));
    this.postEvent = r;
  }
  set isVisible(s) {
...
var Ne = class extends Z {
  constructor({ postEvent: s, ...n }) {
    ...
    c(this, "off", (s2, n2) => s2 === "click" ? $("main_button_pressed", n2) : this.state.off(s2, n2));
    this.postEvent = s;
  }
  /**
...
var us = l(
  ({ postEvent: e, version: t }) => new Le(false, t, e)
);
...
var We = class extends K {
  constructor(s, n, r) {
    ...
    c(this, "off", (s2, n2) => s2 === "click" ? $("settings_button_pressed", n2) : this.state.off(s2, n2));
    this.postEvent = r;
  }
  set isVisible(s) {
...
var je = class {
   ...
   */
  detach() {
    this.attached = false, $("back_button_pressed", this.back);
  }
  /**
