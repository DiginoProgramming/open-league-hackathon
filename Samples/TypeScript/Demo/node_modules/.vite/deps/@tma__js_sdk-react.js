...
var he = (e, t, s) => t in e ? ce(e, t, { enumerable: true, configurable: true, writable: true, value: s }) : e[t] = s;
var c = (e, t, s) => (he(e, typeof t != "symbol" ? t + "" : t, s), s);
function xt(e, t) {
  let s;
  const n = () => {
...
var _e = "ERR_METHOD_UNSUPPORTED";
var we = "ERR_METHOD_PARAMETER_UNSUPPORTED";
var ge = "ERR_UNKNOWN_ENV";
var fe = "ERR_INVOKE_CUSTOM_METHOD_RESPONSE";
var me = "ERR_TIMED_OUT";
var be = "ERR_UNEXPECTED_TYPE";
var St = "ERR_PARSE";
var ve = "ERR_NAVIGATION_LIST_EMPTY";
var ye = "ERR_NAVIGATION_CURSOR_INVALID";
var dn = "ERR_NAVIGATION_ITEM_INVALID";
var _n = "ERR_SSR_INIT";
var Ee = "ERR_INVALID_PATH_BASE";
function T() {
...
var os = l(
  ({ version: e, postEvent: t }) => new is(false, e, t)
);
...
var us = class extends $ {
  constructor({ postEvent: t, createRequestId: s, version: n, botInline: r, ...i }) {
    ...
    this.supports = (o) => a(o) ? o !== "switchInlineQuery" || r : false, this.supportsParam = Xt(n, {
...
var ws = l(
  ({ postEvent: e, version: t }) => new _s(false, t, e)
);
...
var fs = l(
  ({ version: e, postEvent: t }) => new gs(false, e, t)
);
var ms = class extends ht {
  constructor(t, s, n) {
    super({ isVisible: t }, s, {
...
var xs = l(
  ...
  async ({ state: e, platform: t, postEvent: s, addCleanup: n }) => {
    let r = false, i = 0, a = 0, o = 0;
    if (e)
      r = e.isExpanded, i = e.height, a = e.width, o = e.stableHeight;
    else if (["macos", "tdesktop", "unigram", "webk", "weba", "web"].includes(t))
      r = true, i = window.innerHeight, a = window.innerWidth, o = window.innerHeight;
    else {
...
var ne = class {
  constructor(t, s, { postEvent: n, hashMode: r = "classic", base: i } = {}) {
    c(this, "navigator"), c(this, "ee", new D()), c(this, "hashMode"), c(this, "base"), c(this, "attached", false), c(this, "onPopState", ({ state: a }) => {
      if (a === null)
  ...
  function s(n) {
    return function(i, a, o) {
      return (p) => {
        ...
        return (0, import_jsx_runtime.jsx)(o, { ...u });
      };
    };
  }
  return [s(e), s(t)];
}
var re = (0, import_react.createContext)(void 0);
function Os() {
  const e = (0, import_react.useContext)(re);
  if (!e)
...
function _(e) {
  function t(n) {
    const r = Os(), [i, a] = (0, import_react.useState)(
      n ? void 0 : () => {
        if (Ss())
...
var [Yn, Zn] = d(rn, on);
function Xn() {
  return (0, import_react.useMemo)(Qt, []);
}
var [an, cn] = _(Ps);
var [tr, er] = d(an, cn);
var [hn, pn] = _(xs);
...
function rr({ children: e, acceptCustomStyles: t, debug: s }) {
  const n = (0, import_react.useRef)(true), [r, i] = (0, import_react.useState)(/* @__PURE__ */ new Map()), a = (0, import_react.useRef)(r), o = (0, import_react.useCallback)(
    (u) => {
  ...
  }, []), (0, import_jsx_runtime.jsx)(re.Provider, { value: p, children: e });
}
export {
  Ne as BackButton,
