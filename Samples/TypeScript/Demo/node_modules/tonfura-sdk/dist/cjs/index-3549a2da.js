...
const DEFAULT_TONFURA_API_KEY = 'DEFAULT_API_KEY';
const DEFAULT_NETWORK = exports.Network.Mainnet;
...
(function (Method) {
    // accounts
    Method["TON_GET_ADDRESS_INFO"] = "ton_getAddressInformation";
    Method["TON_GET_EXTENDEDADDRESSINFORMATION"] = "ton_getExtendedAddressInformation";
    Method["TON_GET_WALLET_INFORMATION"] = "ton_getWalletInformation";
    Method["TON_GET_ADDRESS_BALANCE"] = "ton_getAddressBalance";
    Method["TON_GET_ADDRESSSTATE"] = "ton_getAddressState";
    Method["TON_PACK_ADDRESS"] = "ton_packAddress";
    Method["TON_UNPACK_ADDRESS"] = "ton_unpackAddress";
    Method["TON_DETECT_ADDRESS"] = "ton_detectAddress";
    Method["TON_GET_TOKEN_DATA"] = "ton_getTokenData";
    // blocks
    Method["TON_GET_MASTERCHAININFO"] = "ton_getMasterchainInfo";
    Method["TON_GET_MASTERCHAINBLOCKSIGNATURES"] = "ton_getMasterchainBlockSignatures";
    Method["TON_GET_SHARDBLOCKPROOF"] = "ton_getShardBlockProof";
    Method["TON_GET_CONSENSUSBLOCK"] = "ton_getConsensusBlock";
    Method["TON_LOOKUP_BLOCK"] = "ton_lookupBlock";
    Method["TON_SHARDS"] = "ton_shards";
    Method["TON_GET_BLOCKHEADER"] = "ton_getBlockHeader";
    // transactions
    Method["TON_GET_TRANSACTIONS"] = "ton_getTransactions";
    Method["TON_GET_BLOCK_TRANSACTIONS"] = "ton_getBlockTransactions";
    Method["TON_TRYLOCATETX"] = "ton_tryLocateTx";
    Method["TON_TRYLOCATERESULTTX"] = "ton_tryLocateResultTx";
    Method["TON_TRYLOCATESOURCETX"] = "ton_tryLocateSourceTx";
    // get config
    Method["TON_GET_CONFIGPARAM"] = "ton_getConfigParam";
    // run method
    Method["TON_RUN_GET_METHOD"] = "ton_runGetMethod";
    // send
    Method["TON_SEND_BOC"] = "ton_sendBoc";
    Method["TON_SEND_BOC_RETURN_HASH"] = "ton_sendBocReturnHash";
    Method["TON_ESTIMATEFEE"] = "ton_estimateFee";
})(Method || (Method = {}));
    ...
    getProvider() {
        if (!this._baseTonfuraProvider) {
            this._baseTonfuraProvider = (() => __awaiter(this, void 0, void 0, function* () {
                const { TonfuraProvider } = yield Promise.resolve().then(function () { return require('./TonfuraProvider-df3debf9.js'); });
...
exports.Tonfura = Tonfura;
exports.getTonfuraHttpUrl = getTonfuraHttpUrl;
//# sourceMappingURL=index-3549a2da.js.map
